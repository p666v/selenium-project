...
public class PracticeSelenium {
    public static void main(String[] args) {
         ...
         *
         *         WebElement element = webDriverWait.until(ExpectedConditions
         *         .visibilityOf(driver.findElement(By.xpath("//img[@alt = 'TEKKEN 8']/ancestor::
         *         a[contains(@class,'app_impression_tracked')]//div[@class = 'discount_final_price']"))));
         *
         *         WebElement element = driver.findElement(By.xpath("//img[@alt = 'TEKKEN 8']/ancestor::
         *         a[contains(@class,'app_impression_tracked')]//div[@class = 'discount_final_price']"));
