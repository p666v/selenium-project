...
public class WaitsDoc {
    public static void main(String[] args) {
         ...
         *
         * alertIsPresent()                          Проверяет наличие или отсутствие предупреждения
         * and()                                     Ожидание с логикой и условием данного списка условий.
         * attributeContains()                       Ожидание проверки WebElement с данным локатором имеет атрибут, который содержит определенное значение.
         * attributeToBe()                           Ожидание проверки данного WebElement имеет атрибут с определенным значением.
         * attributeToBeNotEmpty()                   Ожидание проверки WebElement любого непустого значения для данного атрибута.
